...
class CryptoUtils:
    ...
    def generate_or_load_RSA_keypair(self, owner):
        # create folder for key storage if needed
        os.makedirs(key_folder, exist_ok=True)
        publicKey = None
        privateKey = None
        # check if the keys are already generated and stored in file, if not generate and store new ones
    ...
    def load_RSA_public_key(self, owner):
        # function loads public key of either client or server
        publicKey = None
